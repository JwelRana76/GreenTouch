<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
    <a class="navbar-brand brand-logo" href="{{ url('/admin') }}" style="color: black">GreenTouch </a>
    {{-- <a class="navbar-brand brand-logo-mini" href="{{ url('/admin') }}" style="color: black">GreenTech</a> --}}
  </div>
  <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
    ...
    <ul class="navbar-nav navbar-nav-left header-links">
      <li class="nav-item d-none d-xl-flex">
        <a href="{{ url('/') }}" target="_blank" class="btn btn-success">Website</a>
      </li>
    </ul>
    <ul class="navbar-nav navbar-nav-right">
      ...
      <li class="nav-item dropdown d-none d-xl-inline-block">
        <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
          ...
          <img class="img-xs rounded-circle" src="{{ url('backend/assets/images/faces/face8.jpg') }}" alt="Profile image"> </a>
