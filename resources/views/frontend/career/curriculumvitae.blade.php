...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/assets/scss/app.scss') }}">
                ...
                <div class="col-md-12">
                    ...
                    <div class="career-menu">
                        <ul class="float-end d-flex">
                            <li><a class="printme btn btn-primary">Print</a></li>
                    ...
                    <div class="userdetails mt-3">
                        ...
                        <div class="mailing-address mt-5">
                        ...
                        <div class="career-objective mt-5">
                        ...
                        <div class="academic-information mt-5">
                            <h3 class="bg-secondary bg-opacity-25 mt-3 text-center">Academic Information</h3>
                            @php
                                $education = DB::table('educational_infos')->where('user_id',$user->id)->get();
                            @endphp
                        ...
                        @endif
                        @if ($user->personaldetails)
                        <div class="personal-details mt-5">
                        ...
                        <div class="employment-information mt-5">
